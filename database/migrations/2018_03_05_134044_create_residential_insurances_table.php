...
/**
 * Class CreateResidentialInsurancesTable.
 */
class CreateResidentialInsurancesTable extends Migration
{
	/**
	 * Run the migrations.
	 *
	...
	public function up()
	{
		Schema::create('residential_insurances', function(Blueprint $table) {
            ...
            $table->string('neigbrhood')->nullable();
	...
	{
		Schema::drop('residential_insurances');
	}
}
